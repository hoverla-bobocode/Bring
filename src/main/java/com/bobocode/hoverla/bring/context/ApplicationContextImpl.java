...
public class ApplicationContextImpl implements ApplicationContext {
    ...
    public ApplicationContextImpl(List<BeanScanner> scanners,
        ...
        validator.validateBeanDefinitions(beanDefinitionList);
    ...
    public <T> void register(String name, T instance) {
        SimpleBeanDefinition<T> simpleBeanDefinition = new SimpleBeanDefinition<>(name, instance);
        beanDefinitionTable.put(name, simpleBeanDefinition.type(), simpleBeanDefinition);
    }

    @Override
    public <T> void register(T instance) {
        SimpleBeanDefinition<T> simpleBeanDefinition = new SimpleBeanDefinition<>(instance);
        beanDefinitionTable.put(simpleBeanDefinition.name(), simpleBeanDefinition.type(), simpleBeanDefinition);
    }
